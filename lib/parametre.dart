...
class _ParametresPageState extends State<ParametresPage> {
  ...
  Future<void> _loadSettings() async {
    final settings = AppDatabase.getSettings();
      ...
      child: Row(
        children: [
          ...
          DropdownButton<String>(
            ...
            onChanged: (v) { if (v != null && v != current) _update(key, v); },
          ),
        ],
      ),
    );
                ...
                children: [
                  ...
                  _card([
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        // Ici vous pouvez vraiment vider le cache (par ex. effacer des dossiers)
                  ...
                  _card([
                    const ListTile(
                      leading: Icon(Icons.info_outline, color: kGreen),
                      title: Text('Version de l\'app', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                      trailing: Text('v2.4.1', style: TextStyle(color: kMuted)),
                    ),
                  ]),
                ],
              ),
